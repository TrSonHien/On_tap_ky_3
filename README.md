...
Navigate to this GitHub repository page on your preferred web browser.

Click the green Code button at the top right of the page -> Select Download ZIP.

Once the download finishes, right-click the downloaded ZIP archive and select Extract All... to extract it into a standard folder.

Open the extracted folder and navigate into the tthcm/ directory.

Double-click the index.html file. The Quiz application will instantly boot up inside your default modern web browser (Microsoft Edge, Google Chrome, Brave, etc.).

⚠️ Important Technical Note: Never separate index.html and data.js into different folders or rename them. They must always reside together inside the same tthcm/ folder for the application to pull the database mapping.
...
Best of luck with your revision and ace your upcoming third-semester exams!
